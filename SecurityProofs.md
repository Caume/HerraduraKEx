...
$$\begin{aligned}
&\textbf{Alice:}\quad S = \text{FSCX\_REVOLVE\_N}(C_2,\, B,\, N,\, r) \oplus A \oplus P \quad [= sk_A \oplus P] \\
&\textbf{Bob:}\quad V = \text{FSCX\_REVOLVE\_N}(C,\, B_2,\, N,\, r) \oplus A_2 \oplus S \quad [= sk_B \oplus S]
\end{aligned}$$
...
&N = C \oplus C_2 \quad \text{(derivable from public key;}\; C_2 = \text{FSCX\_REVOLVE}(A_2,\, B_2,\, i)\text{)}
\end{aligned}$$
...
$$\begin{aligned}
D &= \text{FSCX\_REVOLVE\_N}(C_2,\, B,\, N,\, r) \oplus A \oplus E \\
  &= sk_A \oplus \text{FSCX\_REVOLVE\_N}(C,\, B_2,\, N,\, r) \oplus A_2 \oplus P \\
...
$$\text{FSCX\_REVOLVE\_N}(C_2,\, B,\, N,\, r) \oplus A \oplus (E \oplus \delta) \;=\; P \oplus \delta$$
...
$$N \;=\; C \oplus C_2 \;=\; \text{FSCX\_REVOLVE}(A,\, B,\, i) \oplus \text{FSCX\_REVOLVE}(A_2,\, B_2,\, i)$$
...
$C = \text{FSCX\_REVOLVE}(A, B, i)$ with $i = n/4 = 64$ steps. An attacker might attack this by splitting:

$$\text{FSCX\_REVOLVE}(A,\, B,\, i) \;=\; f_B^i(A)$$
