...
Concrete worksheet backing SecurityProofs-2.md §11.6's re-check of
...
# HKEX-RNL's current estimated security (SecurityProofs-2.md §11.6)
...
def main():
    ...
    section5()
    print(SEP)
    print("Done. See SecurityProofs-2.md §11.6 for the write-up.")
    print(SEP)
    print()
