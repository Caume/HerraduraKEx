...
// to affine.  This is the affine class only — NOT the full set of
// differentially weak keys; see SCOPE below.
//
...
// this ZKBoo-(2,3) path -- both prove the same statement/circuit.  C,
// Java and Python all have it too now -- asymmetry #1 (TODO #261) is
...
const (
	...
	// needed.  The cliff has moved from 6->7 to 31->32, leaving this
	// bound conservative by about 5x, and the tail it cuts decodes
	// indistinguishably from an accepted key at this width
	// (SecurityProofs-5.md §11.8.7, "Re-pointed at the deployed parameters").
	qcMdpcMaxMult = 6
)
