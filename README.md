...
Using the following symbols for ROL, ROR and XOR respectively,  $\circlearrowleft, \circlearrowright, \oplus$
<img src="https://render.githubusercontent.com/render/math?math=\circlearrowleft, \circlearrowright, \oplus">, We can rewrite the FSCX definition as follows:
